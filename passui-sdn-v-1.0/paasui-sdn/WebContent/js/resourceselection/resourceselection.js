...
$scope.regResourceSelection = function() {
	...
	var res = $http.post('/PAAS-GUI/rest/policiesService/insertResourceSelection', userData);
...
$scope.selectResourceSelection = function() {
	var response = $http.get('/PAAS-GUI/rest/policiesService/getAllResourceSelection');
...
$scope.deleteResourceSelection = function(data) {
 	var response = $http.get('/PAAS-GUI/rest/policiesService/removeResourceSelectionByRank/'+data);
 	response.success(function(data){
