...
CREATE TABLE `addService` (
  ...
  KEY `user_id` (`user_id`),
  CONSTRAINT `addService_ibfk_1` FOREIGN KEY (`user_id`) REFERENCES `register` (`id`)
) ENGINE=InnoDB DEFAULT CHARSET=latin1;
/*!40101 SET character_set_client = @saved_cs_client */;
...
INSERT INTO `register` VALUES ('biz','bangalore','venkatesh.m@bizruntime.com','Bizruntime@123',1),('biz','bangalore','venkateshm383@bizruntime.com','Bizruntime@123',2),('biz','bangalore','venkateshm3831@gmail.com','Bizruntime@123',3);
...
CREATE TABLE `subnet` (
  ...
  `user_id` int(11) NOT NULL,
  UNIQUE KEY `subnet_name` (`subnet_name`),
  KEY `user_id` (`user_id`),
  CONSTRAINT `subnet_ibfk_1` FOREIGN KEY (`user_id`) REFERENCES `register` (`id`)
) ENGINE=InnoDB DEFAULT CHARSET=latin1;
/*!40101 SET character_set_client = @saved_cs_client */;
...
INSERT INTO `subnet` VALUES ('pass_demo','tenant1-dev','172.168.1.0/24','acl 1','subnet-e8277c75','vpc-d973affa',1);
...
-- Dump completed on 2016-05-05  1:24:56
