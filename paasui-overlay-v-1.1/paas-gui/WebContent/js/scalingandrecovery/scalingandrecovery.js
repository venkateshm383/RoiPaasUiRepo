...
$scope.regSAR = function() {  //Done
	console.log($scope.field);
	var userData = JSON.stringify($scope.field);
	var res = $http.post('/PAAS-GUI/rest/policiesService/addScalingAndRecovery', userData);
...
var response = $http.get('/PAAS-GUI/rest/policiesService/getAllScalingAndRecovery');
...
$scope.deleteSAR = function(data) {
	var response = $http.get('/PAAS-GUI/rest/policiesService/removeScalingAndRecovery/'+data);
	response.success(function(data){
		$scope.select();
	});
	response.error(function(data, status, headers, config) {
