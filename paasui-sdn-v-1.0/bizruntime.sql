...
INSERT INTO `applicantUser` VALUES ('jbossfuse','jbossfuse'),('fuse_demo','fuse_demo'),('paasTest','creating paas apps');
...
--
-- Table structure for table `firewall_type`
--

DROP TABLE IF EXISTS `firewall_type`;
/*!40101 SET @saved_cs_client     = @@character_set_client */;
/*!40101 SET character_set_client = utf8 */;
...
--
-- Dumping data for table `firewall_type`
--

LOCK TABLES `firewall_type` WRITE;
/*!40000 ALTER TABLE `firewall_type` DISABLE KEYS */;
INSERT INTO `firewall_type` VALUES (1,'HTTPS'),(2,'HTTP'),(3,'ALL TCP'),(4,'ALL ICMP'),(5,'ALL UDP');
/*!40000 ALTER TABLE `firewall_type` ENABLE KEYS */;
UNLOCK TABLES;
...
CREATE TABLE `protocol` (
  ...
  `protocol_type` varchar(50) DEFAULT NULL,
  PRIMARY KEY (`pid`)
...
INSERT INTO `protocol` VALUES (1,'TCP'),(2,'ICMP'),(3,'UDP');
...
--
-- Table structure for table `vpc_region`
--

DROP TABLE IF EXISTS `vpc_region`;
/*!40101 SET @saved_cs_client     = @@character_set_client */;
/*!40101 SET character_set_client = utf8 */;
CREATE TABLE `vpc_region` (
  `vpcRegionId` int(11) NOT NULL AUTO_INCREMENT,
  `region` varchar(100) DEFAULT NULL,
  PRIMARY KEY (`vpcRegionId`)
) ENGINE=InnoDB AUTO_INCREMENT=4 DEFAULT CHARSET=latin1;
/*!40101 SET character_set_client = @saved_cs_client */;

--
-- Dumping data for table `vpc_region`
--

LOCK TABLES `vpc_region` WRITE;
/*!40000 ALTER TABLE `vpc_region` DISABLE KEYS */;
INSERT INTO `vpc_region` VALUES (1,'US'),(2,'Germany'),(3,'Austria');
/*!40000 ALTER TABLE `vpc_region` ENABLE KEYS */;
UNLOCK TABLES;
...
-- Dump completed on 2016-04-26 12:36:31
